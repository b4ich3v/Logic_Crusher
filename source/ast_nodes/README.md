...
## **Подробно обяснение на логиката на кода (на български)**
...
Този код предоставя гъвкава и разширяема структура за работа с Булеви изрази. Чрез използването на абстрактно синтактично дърво (AST), програмата може да анализира, опрости, оцени и визуализира сложни Булеви изрази по систематичен начин. Методите за опростяване и преобразуване в Жегалкинова полиномна форма позволяват ефективна работа с изразите в различни контексти, като например минимизация на логически схеми или анализ на функционалните свойства на изразите.

---

Ако имаш допълнителни парчета код, които искаш да коментирам и обясня, можеш да ги споделиш и ще продължа с процеса!
